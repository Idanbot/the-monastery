...
const buttonVariants = cva(
  'ui-focus-ring inline-flex items-center justify-center gap-2 rounded-[var(--ui-radius-control)] text-sm font-semibold transition-[background-color,color,border-color,transform] disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98]',
  {
    variants: {
      variant: {
